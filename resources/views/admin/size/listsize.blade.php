...
<table class="table table-bordered">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                {!!Form::open(array('route' => array('size-list.destroy', $value->id), 'method' => 'DELETE', 'id' => 'delForm')) !!}
                {{ Form::button(trans('backend.view'), ['class' => 'btn btn btn-success listsize fa fa-list ', 'data-id' => $value->id]) }}
                {{ Form::button(trans('backend.edit'), ['class' => 'btn btn btn-primary edit-size fa fa-pencil ', 'data-id' => $value->id]) }}
