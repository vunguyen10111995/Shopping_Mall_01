            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        {!! Form::text('size_name', $value = null, $attribute = ['class' => 'form-control col-md-7 col-xs-12', "placeholder" => trans('backend.pleasezise')]) !!}  
                    </div>
                ...
                {!! Form::label('labelcom', trans('backend.status'), ['class' => 'control-label col-md-3 col-sm-3 col-xs-12']) !!}
                <div class="col-md-6 col-sm-6 col-xs-12">
