    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                {!! Form::label('txtstatus', trans('backend.status'), array('class' => 'control-label col-md-3 col-sm-3 col-xs-12')) !!}
                <div class="col-md-6 col-sm-6 col-xs-12">
                    {{ Form::checkbox('status', '1', $size['status']== 1 ? 'checked' : '') }}
                </div>  
                <div class="form-group">
                    {{ Form::submit(trans('backend.update'), array('class' => 'btn btn-success plus'))}}
                </div>
                {!! Form::close() !!}
            </div>
        </div>
