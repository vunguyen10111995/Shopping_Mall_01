...
<body class="nav-md">
                            ...
                            <ul class="nav side-menu">
                                ...
                                <li><a><i class="fa fa-user" aria-hidden="true"></i> {{ trans('backend.user') }} <span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                                        <li><a href="{{ action('UserController@index') }}">{{ trans('backend.list_user') }}</a></li>
                                        <li><a href="{{ action('UserController@create') }}">{{ trans('backend.add_user') }}</a></li>
                                    </ul>
                                </li>
                                ...
                                <li><a><i class="fa fa-truck"></i>{{ trans('backend.size') }} <span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                                        ...
                                        <li><a href="{{ action('SizeController@create') }}">{{ trans('backend.add_size') }}</a></li>
                                    </ul>
                                </li>
                                <li><a><i class="fa fa-truck"></i>{{ trans('backend.factories') }} <span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                                        <li><a href="{{ action('FactoryController@index') }}">{{ trans('backend.list_factories') }}</a></li>
                                        <li><a href="{{ action('FactoryController@create') }}">{{ trans('backend.add-factory') }}</a></li>
                                    </ul>
                                </li>
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            <li class="">
                                ...
                                <ul class="dropdown-menu dropdown-usermenu pull-right">
                                    ...
                                    <li>
                                        <a href="">
                                            <span class="badge bg-red pull-right">@if (Auth::check()) {!! Auth::user()->full_name !!} @endif </span>
                                            <span>{{ trans('backend.profile') }}</span>
                                        </a>
                                    </li>
                                    <li><a href="{!! url('auth/logout') !!}"><i class="fa fa-sign-out pull-right"></i>{{ trans('backend.logout') }}</a></li>
                                </ul>
                            </li>
                        </ul>
                    </nav>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <iframe src="http://localhost/www/Project_new/Shopping_Mall_01/filemanager/dialog.php?field_id=image" style="border:none; width:100%; height: 500px" ></iframe>
                </div>
    ...
    <div class="modal fade" id="viewfactory">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button> 
                </div>
                <div class="viewfactory">
