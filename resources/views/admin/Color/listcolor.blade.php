    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                {{ Form::button( trans('backend.view'), array('class' => 'btn btn btn-success listcolor fa fa-list ', 'data-id' => $value->id)) }}
                {{ Form::button( trans('backend.edit'), array('class' => 'btn btn btn-primary xoacolor fa fa-pencil ', 'data-id' => $value->id)) }}
