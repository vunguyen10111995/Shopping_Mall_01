...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <div class="form-group">
                    {!! Form::label('labelcate', trans('backend.catename'), ['class' => 'control-label col-md-3 col-sm-3 col-xs-12']) !!}
                </label>
            ...
            <div class="form-group">
                {!! Form::label('txtparent', trans('backend.parentname'), ['class' => 'control-label col-md-3 col-sm-3 col-xs-12']) !!}
            </label>
        ...
        <div class="form-group">
            {!! Form::submit(trans('backend.update'), ['class' => 'btn btn-primary add', 'id' => 'add']) !!}
        </div>
        {!! Form::close() !!}
    </div>
</div>
